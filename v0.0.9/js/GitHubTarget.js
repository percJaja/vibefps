...
const GitHubTarget = {
  ...
  showGitHubLink() {
    ...
    message.textContent = '🎯 비밀 타겟을 발견하셨습니다! 🎯';
    ...
    linkDescription.textContent = '게임 소스 코드를 확인하려면 아래 링크를 클릭하세요:';
    ...
    link.target = '_blank';
    link.textContent = 'GitHub 저장소 방문하기';
    ...
    continueButton.textContent = '게임으로 돌아가기';
    ...
    continueButton.onclick = function() {
      ...
      // 게임 재개 - 수정된 부분
      if (wasGameStarted) {
        // 중요: 애니메이션 루프가 중단되었으므로 다시 시작
        requestAnimationFrame(() => {
          Game.gameStarted = true;
          Game.animate(); // 애니메이션 루프 다시 시작
